    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.php">Kelas Kita</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="?page=admin"><i class="fa fa-desktop fa-3x"></i> Admin</a>
                    </li>

                    <li>
                        <a  href="?page=siswa"><i class="fa fa-users fa-3x"></i> Siswa</a>
                    </li>


                    <li>
                        <a  href="?page=artikel"><i class="fa fa-edit fa-3x"></i> Artikel</a>
                    </li>
